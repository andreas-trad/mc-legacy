window.MotroCortex=function(C){var E=!1;C&&(E=C.hasOwnProperty("debug")?C.debug:!1);var D=[],t=[],u=[],p=this,F=["duration","easing","delay","complete","loop"],G=function(a,d){var e=1*a,f=1*d;d<=a&&(p.log("warn","When using @rand make sure the first parameter is always smaller than the first one. Reverting and proceeding"),f=1*a,e=1*d);return e+(f-e)*Math.random()},w=function(a){return 0==a.indexOf("+=")?"+=":0==a.indexOf("-=")?"-=":0==a.indexOf("-")?"-":""},x=function(a){return-1!==a.indexOf(")px",
    ...
    l[m].units;for(m=0;m<r.length;m++)b[r[m].whichPart][r[m].whichKey]=r[m].pre+G(r[m].byWhichRand[0],r[m].byWhichRand[1])+r[m].units;b.options.complete=function(){v.finished()};t($(this)).velocity(b.attributes,b.options)})}else a.options.complete=function(){k(b,c)},this.selectionFunction(a,b),t(this.selectionFunction(a,b)).velocity(a.attributes,a.options)}};y.prototype.createSelectionFunction=function(a,d){var e=[{name:"index greater than",rxp:new RegExp(/^@index\ *?\>\ *?\d+$/),createSelectionFunction:function(a){return function(m){return":gt("+
    ...
    !0)}}};v.prototype.setOverallEventCallback=function(a){this.parentEvent.setOverallEventCallback()};v.prototype.addThread=function(a,d){this.addTheThread(a,d)};v.prototype.fire=function(a,d,e,f){e||(e=function(){});d||(d={});this.CallbackHandler.init(this.threads.length,e,a,d,this.fire).reset(f);for(e=0;e<this.threads.length;e++)this.threads[e].execute(a,d)};v.prototype.stop=function(){};v.prototype.setLoopTimes=function(a){this.CallbackHandler.setLoopTimes(a)};var H=new function(){var a=this;a.init=
    ...
    a.children[d]);else{e=1;a.children[d].attributes.hasOwnProperty("loop")&&(e=a.children[d].attributes.loop);var e=new v(e,c[c.length-1]);e.addThread(c,a.children[d]);t[c[c.length-1]]=e}f()},error:function(a,b,c){n.log("error","The MSS file "+g+" seems to be missing",c)}})}}};